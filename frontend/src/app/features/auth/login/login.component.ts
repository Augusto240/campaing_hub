    ...
    <div class="auth-page">
      ...
      <div class="auth-card">
        <div class="auth-header">
          <div class="auth-logo">
            <app-icon name="sword" [size]="38"></app-icon>
          </div>
          <h1>Campaign Hub</h1>
          <p>Entre para gerenciar suas aventuras.</p>
        </div>
        ...
        <form (ngSubmit)="onSubmit()" #loginForm="ngForm">
          ...
          <button type="submit" class="btn btn-primary btn-full" [disabled]="!loginForm.form.valid || loading">
...
export class LoginComponent {
  ...
  onSubmit(): void {
    ...
    this.authService.login(this.credentials.email, this.credentials.password).subscribe({
      ...
      error: (error) => {
        this.errorMessage = error.error?.message || 'Falha no login. Tente novamente.';
        this.loading = false;
      },
    });
  }
